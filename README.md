# Back to Geometry: Effective Indoor Space Partitioning from Point Clouds by Integrated 2D-3D Geometric Features (Submitted to ISPRS Journal of Photogrammetry and Remote Sensing）
